...
class HobbiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hobby" do
    assert_difference('Hobby.count') do
      post hobbies_url, params: { hobby: { average-cost: @hobby.average-cost, description: @hobby.description, hobby-name: @hobby.hobby-name, resource: @hobby.resource } }
    end
  ...
  test "should update hobby" do
    patch hobby_url(@hobby), params: { hobby: { average-cost: @hobby.average-cost, description: @hobby.description, hobby-name: @hobby.hobby-name, resource: @hobby.resource } }
